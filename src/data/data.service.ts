...
export class DataService {
    ...
    async getRestaurantsList() {
        ...
        let data1 = JSON.stringify({
            "lat": 12.9351929,
            "lng": 77.62448069999999,
            "nextOffset": "COVCELQ4KICAvOm07cfGejCnEzgD",
            "widgetOffset": {
                "NewListingView_category_bar_chicletranking_TwoRows": "",
                "NewListingView_category_bar_chicletranking_TwoRows_Rendition": "",
                "Restaurant_Group_WebView_SEO_PB_Theme": "",
            ...
            "page_type": "DESKTOP_WEB_LISTING",
            "_csrf": "1dukKrPIsCHo-q_WHD44qUnctocxlfiwSr1IEbyI"
        });
        ...
        return [...response.data?.data?.cards[0]?.card?.card?.gridElements?.infoWithStyle?.restaurants, ...response1.data?.data?.cards[0]?.card?.card?.gridElements?.infoWithStyle?.restaurants]
